...
final_dest = r'd:\Plant_City'

# Quick dictionary to force alignment specifically to bypass the Label Mess
# Non-mapped ones get a generic Title___name format
KNOWN_MAP = {
...
def harmonize_folders(src_dir, dest_dir):
    ...
    for folder in os.listdir(src_dir):
        ...
        # In case a folder maps to the same name from multiple original names
        # or we just need to move files
...
# Rename Plant_Dataset to Plant_Village
if os.path.exists(r'd:\Plant_Dataset'):
    os.rename(r'd:\Plant_Dataset', r'd:\Plant_Village')
